...
export const createUpdateTodoItemSchemaFactory = (t: TFunction) =>
  z.object({
    title: z
      .string()
...
export type UpdateTodoItemFormType = z.infer<
  ReturnType<typeof createUpdateTodoItemSchemaFactory>
>;

export const DEFAULT_UPDATE_TODO_ITEM_FORM_VALUES: UpdateTodoItemFormType = {
  title: "",
  description: "",
  status: "Backlog",
  priority: "Medium",
